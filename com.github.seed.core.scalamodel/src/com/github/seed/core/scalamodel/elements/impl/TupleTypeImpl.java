 ...
 * <ul>
 *   <li>{@link com.github.seed.core.scalamodel.elements.impl.TupleTypeImpl#getTypes <em>Types</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TupleTypeImpl extends TypeImpl implements TupleType {
	...
	protected EClass eStaticClass() {
		return ScalaModelPackage.Literals.TUPLE_TYPE;
	}
	...
	public EList<Type> getTypes() {
		if (types == null) {
			types = new EObjectResolvingEList<Type>(Type.class, this, ScalaModelPackage.TUPLE_TYPE__TYPES);
		}
		return types;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ScalaModelPackage.TUPLE_TYPE__TYPES:
				return getTypes();
		}
